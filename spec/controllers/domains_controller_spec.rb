...
describe DomainsController do
  ...
  let(:valid_attributes) { { "domain" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved domain as @domain" do
        ...
        post :create, {:domain => { "domain" => "invalid value" }}, valid_session
        assigns(:domain).should be_a_new(Domain)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested domain" do
        ...
        Domain.any_instance.should_receive(:update).with({ "domain" => "MyString" })
        put :update, {:id => domain.to_param, :domain => { "domain" => "MyString" }}, valid_session
      end
